...
export { FileTypeIcon } from "@/features/files/components/file-icon";
export {
  basename,
  formatBytes,
  joinFsPath,
...
export {
  ...
  openFile,
  saveText,
} from "@/features/files/lib/open-file";
export { useFiles } from "@/features/files/hooks/use-files";
export type { FilesController } from "@/features/files/hooks/use-files";
export type {
  FileTransferKind,
  FileTransferState,
  OpenedFile,
